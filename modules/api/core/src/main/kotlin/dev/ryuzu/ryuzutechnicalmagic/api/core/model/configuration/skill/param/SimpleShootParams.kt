package dev.ryuzu.ryuzutechnicalmagic.api.core.model.configuration.skill.param
...
data class SimpleShootParams(
    ...
    val repeat: Int = 0,
    val maxRepeat: Int = 0,
) : dev.ryuzu.ryuzutechnicalmagic.api.core.model.configuration.skill.param.ISkillParams