...
sealed interface IConfiguredDisplay {
    ...
    val animation: List<dev.ryuzu.ryuzutechnicalmagic.api.core.configuration.util.effect.display.ConfiguredAnimationDisplay>
    ...
    data class ConfiguredItemDisplay(
        ...
        override val animation: List<dev.ryuzu.ryuzutechnicalmagic.api.core.configuration.util.effect.display.ConfiguredAnimationDisplay>,
        val item: String
    ) : IConfiguredDisplay
    ...
    data class ConfiguredTextDisplay(
        ...
        override val viewRange: Float = 1F,
        override val transformation: ConfiguredTransformation = ConfiguredTransformation(),
        override val animation: List<dev.ryuzu.ryuzutechnicalmagic.api.core.configuration.util.effect.display.ConfiguredAnimationDisplay> = emptyList(),
