...
abstract class AbstractGeneratorService(
    ...
    private val starStocks: MutableMap<dev.ryuzu.ryuzutechnicalmagic.api.core.data.game.generator.ConfiguredStarGenerator, StarStockData> = mutableMapOf()
    private val itemStocks: MutableMap<dev.ryuzu.ryuzutechnicalmagic.api.core.data.game.generator.ConfiguredItemGenerator, MutableSet<IEntity>> = mutableMapOf()
