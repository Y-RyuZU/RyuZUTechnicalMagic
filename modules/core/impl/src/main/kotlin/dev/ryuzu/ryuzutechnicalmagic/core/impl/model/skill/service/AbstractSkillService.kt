...
import dev.ryuzu.ryuzutechnicalmagic.api.core.model.skill.service.ICoolTimeService
...
abstract class AbstractSkillService : ISkillService, KoinComponent {
    ...
    private var skillSets: HashMap<String, ConfiguredSkillSet> = hashMapOf(get(named("SkillSetConfig")))
    private var skills: HashMap<String, ConfiguredSkillParams> = hashMapOf(get(named("SkillConfig")))
