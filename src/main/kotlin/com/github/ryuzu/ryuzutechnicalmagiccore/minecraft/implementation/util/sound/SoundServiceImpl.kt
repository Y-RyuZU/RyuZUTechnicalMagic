package com.github.ryuzu.ryuzutechnicalmagiccore.minecraft.implementation.util.sound
...
import com.github.ryuzu.ryuzutechnicalmagiccore.core.util.sound.AbstractSoundService
...
class SoundServiceImpl : AbstractSoundService() {
    override fun playSound(soundSet: ConfiguredSoundSet, sound: ConfiguredSound, player: UUID) {
