...
class CarryTntServiceImpl(
    ...
    private val listener: ICarryTntListener by inject()
    ...
    override fun createPlayer(player: IPlayer): ICarryTntPlayer = ICarryTntPlayer.CarryTntPlayer(player, selectTeamAlgorithm(player) as CarryTntTeam)
